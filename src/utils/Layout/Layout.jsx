...
const Layout = ({theme}) => {     
    ...
    return (
        <div className={theme.color === "white" ? "body-light" : "body-dark"}>            
            ...
            <div className="cards"> 
                <Card title="Business" description="A small card printed with one's name, email address, and contact information." setOpenModal={setOpenBusinessCardModal} filterItem="cards" serialNo={1} theme={theme} />
                {
                openBusinessCardModal && 
                <Modal component={<BusinessCard />} closeModal={setOpenBusinessCardModal} />
                }

                <Card title="Happy New Year" description="Animation gradually changes from 2021 to 2022 on hover" setOpenModal={setOpenYearChangerModal} filterItem="buttons" serialNo={2} theme={theme} />
                {
                    openYearChangerModal && 
                    <Modal component={<YearChanger />} closeModal={setOpenYearChangerModal} />
                }

                <Card title="Neumorphism Clock" description="New visually pleasing cool trend in a design inspired by Skeuomorphism with a more minimal approach Neumorphism (New+Skeuomorphism)"  setOpenModal={setOpenClockModal} filterItem="glass" serialNo={3} theme={theme} />
                {
                    openClockModal && 
                    <Modal component={<Clock />} closeModal={setOpenClockModal} />
                }

                <Card title="Falling Leaves" description="Emulate autumn leaves falling only using css animations" setOpenModal={setOpenLeavesModal} filterItem="abstract" serialNo={4} theme={theme} />
                {
                    openLeavesModal && 
                    <Modal component={<Leaves />} closeModal={setOpenLeavesModal} />
                }

                <Card title="Loader" description="Used for notifications that reassure users that the system is still handling their request" setOpenModal={setOpenLoaderModal} filterItem="abstract" serialNo={5} theme={theme} />
                {
                    openLoaderModal && 
                    <Modal component={<Loader />} closeModal={setOpenLoaderModal} />
                }

                <Card title="3D Isometric Icons" description="Isometric design for shorthand symbols that link to company's profile on different networks" setOpenModal={setOpenSocialMediaIconsModal} filterItem="icons" serialNo={6} theme={theme} />
                {
                    openSocialMediaIconsModal && 
                    <Modal component={<SocialMediaIcons />} closeModal={setOpenSocialMediaIconsModal} />
                }
                
                <Card title="Glowing Cube" description="Ambient light 3D glowing cube with text animation effect" setOpenModal={setOpenGlowingCubeModal} filterItem="abstract" serialNo={7} theme={theme} />
                {
                    openGlowingCubeModal && 
                    <Modal component={<GlowingCube />} closeModal={setOpenGlowingCubeModal} />
                }

                <Card title="Smooth Animated Blob" description="Blob animation effect using SVG" setOpenModal={setOpenBlobModal} filterItem="abstract" serialNo={8} theme={theme} />
                {
                    openBlobModal && 
                    <Modal component={<Blob />} closeModal={setOpenBlobModal} />
                }

                <Card title="Glowing Particles" description="Random particles background animation effect" setOpenModal={setOpenParticlesModal} filterItem="nature" serialNo={9} theme={theme} />
                {
                    openParticlesModal && 
                    <Modal component={<Particles />} closeModal={setOpenParticlesModal} />
                }

                <Card title="Water Bubbles Background" description="Background animation with creative water bubbles" setOpenModal={setOpenWaterModal} filterItem="nature" serialNo={10} theme={theme} />
                {
                    openWaterModal && 
                    <Modal component={<Water />} closeModal={setOpenWaterModal} />
                }

                <Card title="Rocket" description="Also known as image carousels or slideshows are a convenient way to display multiple images, videos, or graphics" setOpenModal={setOpenRocketModal} filterItem="abstract" serialNo={11} theme={theme} />
                {
                    openRocketModal && 
                    <Modal component={<Rocket />} closeModal={setOpenRocketModal} />
                }

                <Card title="Oxygen Wave" description="A water wave with oxygen text hover effect" setOpenModal={setOpenWaveModal} filterItem="nature" serialNo={12} theme={theme} />
                {
                    openWaveModal && 
                    <Modal component={<Wavy />} closeModal={setOpenWaveModal} />
                }

                <Card title="Smiley Rating Bar" description="A simple rating bar which displays animated smileys as rating icon" setOpenModal={setOpenSmileyModal} filterItem="buttons" serialNo={13} theme={theme} />
                {
                    openSmileyModal && 
                    <Modal component={<Smiley />} closeModal={setOpenSmileyModal} />
                }

                <Card title="Quote Of The Day" description="Creative design with hover animation effect" setOpenModal={setOpenBoxModal} filterItem="cards" serialNo={14} theme={theme} />
                {
                    openBoxModal && 
                    <Modal component={<Box />} closeModal={setOpenBoxModal} />
                }

                <Card title="Button Hover Effects" description="Various hover effects and animations for buttons" setOpenModal={setOpenButtonModal} filterItem="buttons" serialNo={15} theme={theme} />
                {
                    openButtonModal && 
                    <Modal component={<Button />} closeModal={setOpenButtonModal} />
                }

                <Card title="Glowing Gradient Card" description="Various hover effects and animations for buttons" setOpenModal={setOpenGlassCardModal} filterItem="cards" serialNo={16} theme={theme} />
                {
                    openGlassCardModal && 
                    <Modal component={<GlassCard />} closeModal={setOpenGlassCardModal} />
                }

                <Card title="Glass Shutter" description="Shutter effect based on progress bar" setOpenModal={setOpenShutterModal} filterItem="glass" serialNo={17} theme={theme} />
                {
                    openShutterModal && 
                    <Modal component={<Shutter />} closeModal={setOpenShutterModal} />
                }

                <Card title="Greeting Card" description="Greeting - 3D foldable card on hover" setOpenModal={setOpenGreetingModal} filterItem="cards" serialNo={18} theme={theme} />
                {
                    openGreetingModal && 
                    <Modal component={<Greeting />} closeModal={setOpenGreetingModal} />
                }

                <Card title="Parallax Effect" description="An effect where background images move past the camera more slowly than foreground images, creating an illusion of depth in a 2D scene of distance. (NOT SUPPORTED IN MOBILE BROWSERS)" setOpenModal={setOpenParallaxModal} filterItem="abstract" serialNo={19} theme={theme} />
                {
                    openParallaxModal && 
                    <Modal component={<Parallax />} closeModal={setOpenParallaxModal} />
                }

                <Card title="Calculator" description="Basic functional calculator with animations" setOpenModal={setOpenCalculatorModal} filterItem="glass" serialNo={20} theme={theme} />
                {
                    openCalculatorModal && 
                    <Modal component={<Calculator />} closeModal={setOpenCalculatorModal} />
                }

                <Card title="Starry Night Banner" description="Banner with clouds and stars animation effect" setOpenModal={setOpenBannerModal} filterItem="nature" serialNo={21} theme={theme} />
                {
                    openBannerModal && 
                ...
                <Card title="Colorful Squares" description="Animated background animation which randomly creates colorful squares" setOpenModal={setOpenSquaresModal} filterItem="abstract" serialNo={23} theme={theme} />
                {
                    openSquaresModal && 
                    <Modal component={<Squares />} closeModal={setOpenSquaresModal} />
                }

                <Card title="Font Awesome Icons" description="Animated background animation using font-awesome icons" setOpenModal={setOpenFontAwesomeIconsModal} filterItem="icons" serialNo={24} theme={theme} />
                {
                    openFontAwesomeIconsModal && 
                    <Modal component={<FontAwesomeIcons />} closeModal={setOpenFontAwesomeIconsModal} />
                }

                <Card title="Checkbox UI" description="Animated checkbox UI animation" setOpenModal={setOpenCheckboxModal} filterItem="buttons" serialNo={25} theme={theme} />
                {
                    openCheckboxModal && 
                    <Modal component={<Checkbox />} closeModal={setOpenCheckboxModal} />
                }

                <Card title="Climb" description="A box climbing up the hill animation" setOpenModal={setOpenClimbModal} filterItem="abstract" serialNo={26} theme={theme} />
                {
                    openClimbModal && 
                    <Modal component={<Climb />} closeModal={setOpenClimbModal} />
                }

                <Card title="Shapes" description="A set of square and circlular shaped objects floating around" setOpenModal={setOpenShapesModal} filterItem="abstract" serialNo={27} theme={theme} />
                {
                    openShapesModal && 
                    <Modal component={<Shapes />} closeModal={setOpenShapesModal} />
                }

                <Card title="Mousemove Card" description="3D card with parallax and tilt effect on mousemove" setOpenModal={setOpenTiltCardModal} filterItem="cards" serialNo={28} theme={theme} />
                {
                    openTiltCardModal && 
                    <Modal component={<TiltCard />} closeModal={setOpenTiltCardModal} />
                }

                <Card title="5 Star Skills Rating Bar" description="A scale used to display skills in one's technology stack" setOpenModal={setOpenSkillsBarModal} filterItem="buttons" serialNo={29} theme={theme} />
                {
                    openSkillsBarModal && 
                ...
                <Card title="Colorful Rain" description="Animated rain with randomized color" setOpenModal={setOpenRainModal} filterItem="abstract" serialNo={32} theme={theme} />
                {
                    openRainModal && 
                    <Modal component={<Rain />} closeModal={setOpenRainModal} />
                }

                <Card title="Balancer" description="Physics animations using basic CSS" setOpenModal={setOpenBalancerModal} filterItem="nature" serialNo={33} theme={theme} />
                {
                    openBalancerModal && 
                    <Modal component={<Balancer />} closeModal={setOpenBalancerModal} />
                }

                <Card title="Battery Indicator" description="A visual indication of the battery's state of charge with mousemove tilt effect" setOpenModal={setOpenBatteryIndicatorModal} filterItem="glass" serialNo={34} theme={theme} />
                {
                    openBatteryIndicatorModal && 
                    <Modal component={<BatteryIndicator />} closeModal={setOpenBatteryIndicatorModal} />
                }

                <Card title="Cricketers Rank List" description="A list of the famous cricketers made by an official organization" setOpenModal={setOpenRankListModal} filterItem="glass" serialNo={35} theme={theme} />
                {
                    openRankListModal && 
